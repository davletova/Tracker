...
//    func filterTrackers(by name: String, date: Date) -> [TrackersByCategory]
//    func createTracker(tracker: Tracker)
//}
//
//final class TrackerService {
//    var categories = [TrackersByCategory]()
//}
//
...
//        }
//
//        categories.append(TrackersByCategory(categoryName: tracker.category, trackers: [tracker]))
//
//        NotificationCenter.default.post(
//            name: TrackerCollectionView.TrackerSavedNotification,
//            object: self,
